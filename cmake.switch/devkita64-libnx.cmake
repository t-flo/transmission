...
set(ARCH "-march=armv8-a+crc+crypto -mtune=cortex-a57 -mtp=soft -fPIC")
set(CMAKE_C_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} -MMD -MP -g -Wall -O2 -ffunction-sections ${ARCH} -isystem${DEVKITPRO}/libnx/include")
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} ${CMAKE_CXX_FLAGS_INIT} -fno-rtti -fno-exceptions")
set(CMAKE_EXE_LINKER_FLAGS_INIT "${ARCH} -ftls-model=local-exec -L${LIBNX}/lib -L${PORTLIBS}/lib -specs=/opt/devkitpro/libnx/switch.specs -lnx")
